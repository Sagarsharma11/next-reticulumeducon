                        ...
                        <div className="relative h-full flex flex-col justify-center px-6 md:px-16 lg:px-24">
                            <div className="max-w-3xl space-y-5 md:space-y-6 pt-12 md:pt-0">
                                ...
                                <div className="flex flex-wrap gap-4">
                                    <a href="/contact-us" className="px-8 py-3.5 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-bold rounded-xl transition-all shadow-lg shadow-orange-500/30 transform hover:-translate-y-1">
                                        Get Free Counseling
                                    </a>
