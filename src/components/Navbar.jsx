...
//   useEffect(() => {
//     const alreadyShown = sessionStorage.getItem("counselling_modal_shown");
//     if (alreadyShown) return;

//     const timer = setTimeout(() => {
//       setOpen(true);
//       sessionStorage.setItem("counselling_modal_shown", "true");
//     }, 3000);
...
//             </a>
//             <a href="tel:+918862851969" className="nb-topbar-item">
//               <span className="nb-topbar-icon">📞</span> +91-8862851969
//             </a>
//           </div>
...
//               <img src="/assets/images/logo/logo.png" alt="Reticulum Educon"
//                 className="h-16 w-auto transform transition-all duration-300 hover:scale-110 hover:-translate-y-0.5"
...
//             <img src="/assets/images/logo/logo.png" alt="Logo" style={{ height: 36 }} />
//           </a>
...
//           <button className="text-[#ea580c]" onClick={() => { setOpen(true); setMobileOpen(false) }}>
...
export default function Navbar() {
  ...
  return (
    <>
      <style>{`
        ...
        .nb-bar.scrolled .nb-inner { height: 70px; }
        ...
        .nb-bar.scrolled .nb-logo img { height: 52px; }
  ...
  0% { box-shadow: 0 4px 18px rgba(249,115,22,0.35), 0 0 0 0 rgba(249,115,22,0.5); }
  70% { box-shadow: 0 4px 18px rgba(249,115,22,0.35), 0 0 0 12px rgba(249,115,22,0); }
  100% { box-shadow: 0 4px 18px rgba(249,115,22,0.35), 0 0 0 0 rgba(249,115,22,0); }
}
...
.nb-cta {
  animation: pulse-ring 2s ease-out infinite, wiggle 3s ease-in-out infinite;
  border: none;
  font-family: 'Inter', sans-serif;
}
...
.nb-cta:hover {
  ...
  animation: none;
          ...
          <div className="nb-inner">
            ...
            <a href="/" className="nb-logo">
              <img
                ...
                alt="Reticulum Educon"
                className="w-auto transform transition-all duration-300 hover:scale-110 hover:-translate-y-0.5"
              />
            </a>
              ...
              <li className="nb-drop-wrap" ref={dropRef}>
                ...
                <div className={`nb-mega ${dropOpen ? "open" : ""}`}>
                  ...
                  <div className="nb-mega-footer">
                    <span className="nb-mega-footer-text">Need help choosing?</span>
                    <button
                      className="nb-mega-footer-link"
                      onClick={() => { setDropOpen(false); setOpen(true); }}
                    >
                      Free Counselling →
                    </button>
                  </div>
            ...
            {/* Desktop CTA */}
            <button onClick={() => setOpen(true)} className="nb-cta">
              📞 Free Counselling
            </button>
      ...
      <div className={`nb-drawer ${mobileOpen ? "open" : ""}`}>
        ...
        <div className="nb-drawer-section">
          <span className="nb-drawer-label">Navigation</span>
          {navLinks.map((l) => (
            <a
              key={l.href}
              href={l.href}
        ...
        <div className="nb-drawer-section">
          <span className="nb-drawer-label">MBBS Abroad — Select Country</span>
        </div>
