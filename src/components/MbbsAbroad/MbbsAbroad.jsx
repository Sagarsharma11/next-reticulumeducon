...
const MbbsAbroad = () => {
    ...
    const universityList = [
        {
            img: "/assets/images/university/Ivanovo_state_medical_university_russia.jpeg",
            name: "Ivanovo State Medical University",
            country: "Russia"
        },
        {
            img: "/assets/images/university/north_caucasian.jpeg",
            name: "North Caucasian State Medical University",
            country: "Russia"
        },
        {
            img: "/assets/images/university/bukhara_state_medical_university_uzbekistan.jpeg",
            name: "Bukhara State Medical University",
            country: "Uzbekistan"
        },
        {
            img: "/assets/images/university/namangan_state_medical_university_uzbekistan.jpeg",
            name: "Namangan State Medical University",
            country: "Uzbekistan"
        },
        {
            img: "/assets/images/university/tashkent_state_medical_university_uzbekistan.jpeg",
            name: "Tashkent State Medical University",
            country: "Uzbekistan"
        },
        {
            img: "/assets/images/university/voronezh_state_medical_university_russia.jpeg",
            name: "Voronezh State Medical University",
            country: "Russia"
        },
        {
            img: "/assets/images/university/yaroslavl_state_medical_university_russia.jpeg",
