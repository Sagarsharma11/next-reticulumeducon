        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-5 flex flex-col gap-6">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 flex-1">
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-full bg-orange-50 flex items-center justify-center flex-shrink-0 text-base">📍</div>
                    <div>
                      <p className="text-sm font-semibold text-gray-900 mb-0.5">Head Office</p>
                      <p className="text-gray-500 text-sm leading-relaxed">
                        Bagdulhan, Infront of The Regal Palace,<br />
                        Near P.K. Jha School, Hajipur, Patna (Bihar)
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-3 w-full">
                      <p className="text-sm font-semibold text-gray-900">Branch Offices</p>

                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div className="bg-orange-50/50 rounded-xl p-3 border border-orange-100">
                          <p className="text-xs font-bold text-orange-500 uppercase tracking-wide mb-1">Bengaluru, Karnataka</p>
                          <p className="text-gray-500 text-xs leading-relaxed">
                            26/3-58, 1st Floor, Opp. Sangeetha Mobiles, New Bank Colony, Konanakute
                          </p>
                        </div>

                        <div className="bg-orange-50/50 rounded-xl p-3 border border-orange-100">
                          <p className="text-xs font-bold text-orange-500 uppercase tracking-wide mb-1">Bhubaneswar, Odisha</p>
                          <p className="text-gray-500 text-xs leading-relaxed">
                            Plot No. 1552/9266, Satya Vihar, Bhomikhal, Near Apollo Pharma – 751010
                          </p>
                        </div>

                        <div className="bg-orange-50/50 rounded-xl p-3 border border-orange-100">
                          <p className="text-xs font-bold text-orange-500 uppercase tracking-wide mb-1">Bhagalpur, Bihar</p>
                          <p className="text-gray-500 text-xs leading-relaxed">
                            Asanandpur Muslim Minority Degree College, Opp. Gate No. 2
                          </p>
                        </div>

                        <div className="bg-orange-50/50 rounded-xl p-3 border border-orange-100">
                          <p className="text-xs font-bold text-orange-500 uppercase tracking-wide mb-1">Jamshedpur, Jharkhand</p>
                          <p className="text-gray-500 text-xs leading-relaxed">
                            Plot No. 902, Road No. 15, Near Nature Park Gate, Mango
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-full bg-orange-50 flex items-center justify-center flex-shrink-0 text-base">📞</div>
                    <div>
                      <p className="text-sm font-semibold text-gray-900 mb-0.5">Phone Numbers</p>
                      <a href="tel:+918862851969" className="text-gray-500 hover:text-orange-600 text-sm block transition-colors">+91 88628-51969</a>
                      <a href="tel:+917667962400" className="text-gray-500 hover:text-orange-600 text-sm block transition-colors">+91 76679-62400</a>
                      <a href="tel:+917665865778" className="text-gray-500 hover:text-orange-600 text-sm block transition-colors">+91 76658-65778</a>
                    </div>
                  </div>

                  {/* Email */}
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-full bg-orange-50 flex items-center justify-center flex-shrink-0 text-base">✉️</div>
                    <div>
                      <p className="text-sm font-semibold text-gray-900 mb-0.5">Email Address</p>
                      <a href="mailto:reticulumeducon@gmail.com" className="text-gray-500 hover:text-orange-600 text-sm transition-colors">
                        reticulumeducon@gmail.com
                      </a>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <a href="https://wa.me/917667962400" target="_blank" rel="noreferrer"
                      style={{ background: "#25D366", color: "#fff" }}
                      className="w-9 h-9 rounded-full flex items-center justify-center hover:opacity-80 transition-all">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2A10 10 0 0 0 2 12a9.8 9.8 0 0 0 1.4 5.2L2 22l4.9-1.3A10 10 0 1 0 12 2zm4.3 13.6c-.3.9-1.5 1.6-2.6 1.6-.6 0-1.4-.2-2.2-.6-1.1-.6-2.2-1.8-3-3.1-.7-1.2-1-2.2-.9-3 .2-1.1.9-2.3 1.8-2.5h.6c.2 0 .5.6.7 1.3.1.7.3 1.3.2 1.5-.1.3-.2.3-.4.6-.2.2-.3.3-.5.5-.2.2-.4.4-.2.7.1.3.5.8.8 1.2.5.6 1.1 1.1 1.8 1.4.2.1.4.1.6-.1.2-.2.8-.9 1-.9s.5 0 .8.2c.3.1 1 .4 1.1.5.2.1.3.2.4.3 0 .3 0 .7-.1 1z" /></svg>
                    </a>
                    <a href="https://www.instagram.com/reticulum_mbbsabroad?igsh=NmtsNXQ2Zm02aDNk" target="_blank" rel="noreferrer"
                      style={{ background: "radial-gradient(circle at 30% 107%, #fdf497 0%, #fd5949 45%, #d6249f 60%, #285AEB 90%)", color: "#fff" }}
                      className="w-9 h-9 rounded-full flex items-center justify-center hover:opacity-80 transition-all">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M7 2C4.24 2 2 4.24 2 7v10c0 2.76 2.24 5 5 5h10c2.76 0 5-2.24 5-5V7c0-2.76-2.24-5-5-5H7zm10 2c1.66 0 3 1.34 3 3v10c0 1.66-1.34 3-3 3H7c-1.66 0-3-1.34-3-3V7c0-1.66 1.34-3 3-3h10zM12 7a5 5 0 100 10 5 5 0 000-10zm0 2a3 3 0 110 6 3 3 0 010-6zm4.5-2.9a1.1 1.1 0 100 2.2 1.1 1.1 0 000-2.2z" /></svg>
                    </a>
                    <a href="https://www.facebook.com/people/Reticulum-Educon/61575752228683/" target="_blank" rel="noreferrer"
                      style={{ background: "#1877F2", color: "#fff" }}
                      className="w-9 h-9 rounded-full flex items-center justify-center hover:opacity-80 transition-all">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M22 12a10 10 0 1 0-11.5 9.9v-7H7v-3h3.5V9.5c0-3.4 2-5.2 5-5.2 1.4 0 2.9.3 2.9.3v3.2H16c-1.6 0-2.1 1-2.1 2v2.2h3.6l-.6 3h-3v7A10 10 0 0 0 22 12z" /></svg>
                    </a>
                    <a href="https://www.youtube.com/@mbbs-abroad_reticulum" target="_blank" rel="noreferrer"
                    ...
                    <a href="https://x.com/RETICULUMEDUCON" target="_blank" rel="noreferrer"
                      style={{ background: "#000000", color: "#fff" }}
                      className="w-9 h-9 rounded-full flex items-center justify-center hover:opacity-80 transition-all">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.74l7.73-8.835L1.254 2.25H8.08l4.253 5.622L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z" /></svg>
                    </a>
                    <a href="https://www.linkedin.com/in/reticulum-educon-937187229" target="_blank" rel="noreferrer"
                      style={{ background: "#0A66C2", color: "#fff" }}
                      className="w-9 h-9 rounded-full flex items-center justify-center hover:opacity-80 transition-all">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2z M4 6a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" /></svg>
                    </a>
                  </div>
                </div>
              </div>
              ...
              {/* Map */}
              <div className="rounded-3xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 h-56">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d898.8244452823602!2d85.21743877917665!3d25.694562907473244!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39ed5d66d5959793%3A0xf8208c995c7b4b9e!2sRETICULUM%20EDUCON%20LLP!5e0!3m2!1sen!2sin!4v1643443515439!5m2!1sen!2sin"
                  className="w-full h-full border-0"
                  allowFullScreen={false}
            ...
            {/* Right Column: Form — sticky top so it aligns nicely */}
            <div className="lg:col-span-7 lg:sticky lg:top-8 self-start">
              <CounsellingForm formData={formData} handleChange={handleChange} sendToWhatsApp={sendToWhatsApp} />
            </div>
