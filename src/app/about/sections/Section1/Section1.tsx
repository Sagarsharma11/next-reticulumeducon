            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white rounded-3xl p-8 md:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 text-lg md:text-[19px] leading-relaxed text-gray-700 relative overflow-hidden">
                    ...
                    <p className="mb-6 relative z-10">
                        <strong className="text-orange-600 font-extrabold">Reticulum Educon</strong> is a trusted and leading educational consultancy dedicated to guiding students on their journey toward a successful career in the field of medicine. We specialize in providing authentic, transparent and reliable counseling to help aspiring medical professionals find the right path to achieve their dreams.
                    </p>

                    <div className="relative z-10 bg-slate-50 border-l-4 border-orange-500 p-6 md:p-8 rounded-r-2xl">
